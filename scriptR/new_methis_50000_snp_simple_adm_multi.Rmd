...
write_ic_var_plot(mat_cstt_multi_mean, mat_cstt_multi_mean$Generation,
                  ...
                  -0.12, 0.03, "Ne", "100_simu/delta.adm0.adm/delta_adm0_ne_cstt_multi",
                  -0.1, 0.03, mat_cstt_multi_var$delta.adm.gen.0,
                  "100_simu/delta.adm0.adm/delta_adm0_ne_cstt_multi_IC95",
...
```{r}
write_increase_plot("delta.mean.adm.props", mat_inc_multi_mean, "delta_mean_adm/delta_mean_pop_inc_nu_va_multi", -0.1, 0.01, ylab=expression(paste(δ[µ["observée"]-µ["théorique"]], sep = "")))
...
write_ic_var_plot(mat_inc_multi_mean, mat_inc_multi_mean$Generation,
                  ...
                  mat_inc_multi_mean$U, mat_inc_multi_mean$U,
                  "Delta mean adm props en fonction des générations",
                  -0.1, 0, "U", "100_simu/delta.adm0.adm/delta_adm0_ne_inc_mean",
                  -0.1, 0.03, mat_inc_multi_var$delta.adm.gen.0,
                  "100_simu/delta.adm0.adm/delta_adm0_ne_inc_mean_IC95",
                  ylab=expression(paste(δ[µ["g"]-µ[0]], sep = "")))
...
write_ic_var_plot(mat_bot_multi_mean, mat_bot_multi_mean$Generation,
                  ...
                  mat_bot_multi_mean$U, mat_bot_multi_mean$U,
                  "Delta mean adm props en fonction des générations",
                  -0.1, 0, "U", "100_simu/delta.adm0.adm/delta_adm0_ne_bott_mean",
                  -0.1, 0.03, mat_bot_multi_var$delta.adm.gen.0,
                  "100_simu/delta.adm0.adm/delta_adm0_ne_bott_mean_IC95", bot = c(80),
                  ylab=expression(paste(δ[µ["g"]-µ[0]], sep = "")))
...
for (i in c(1:4)) {
  ...
  write_ic_var_plot(lst_tmp[[i]],lst_tmp[[i]]$Generation,
                    ...
                    "Delta mean adm props en fonction des générations",-0.15, 0.1, "Ne",
                    str_c("100_simu/delta.adm0.adm/delta_adm_ne_inc_multi_s10_",vec_s10[i]),
                    -0.15, 0.05, lst_var[[i]]$delta.adm.gen.0,
                    str_c("100_simu/delta.adm0.adm/delta_adm_ne_inc_multi_s10_",vec_s10[i],"_ic95"),
                    ylab=expression(paste(δ[µ["g"]-µ[0]], sep = "")))
}
remove(lst_tmp)
remove(vec_s10)
...
for (i in c(1:4)) {
  ...
  write_ic_var_plot(lst_tmp[[i]],lst_tmp[[i]]$Generation,
                    ...
                    lst_tmp[[i]]$U,lst_tmp[[i]]$U,
                    "Delta mean adm props en fonction des générations",-0.15, 0.1, "Ne",
                    str_c("100_simu/delta.adm0.adm/delta_adm_ne_bot_multi_s10_",vec_s10[i]),
                    -0.15, 0.05, lst_var[[i]]$delta.adm.gen.0,
                    str_c("100_simu/delta.adm0.adm/delta_adm_ne_bot_multi_s10_",vec_s10[i],"_ic95"),
