...
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_cstt_var", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_cstt_var", ".png"), plot = p)
...
p = p+geom_point()
p = p+ggtitle("F moyen en fonction de s1,0 à la génération 100")
p = p + xlab("s1.0") + ylab("delta mean adm props")
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
