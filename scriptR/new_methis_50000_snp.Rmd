...
p = ggplot(mat_cstt_multi_100, aes(x = s1.0, y = delta.mean.adm.props, color = Ne))
p = p+geom_point()
...
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_100/ne_cstt_delta_s10", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_100/ne_cstt_delta_s10", ".png"), plot = p)

####################

p = ggplot(mat_cstt_multi_gen0, aes(x = s1.0, y = delta.mean.adm.props, color = Ne))
p = p+geom_point()
p = p + xlab("s1.0") + ylab("delta mean adm props")
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/ne_cstt_delta_s10", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/ne_cstt_delta_s10", ".png"), plot = p)

####################

p = ggplot(mat_cstt_multi_gen0, aes(x = s1.0, y = mean.adm.props, color = Ne))
p = p+geom_point()
p = p + xlab("s1.0") + ylab("mean adm props")
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
                                                linetype = 'solid',
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/ne_cstt_mean_adm_s10", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/ne_cstt_mean_adm_s10", ".png"), plot = p)
...
p = ggplot(mat_cstt_multi_gen0, aes(x = s1.0, y = Fst.s1.adm, color = Ne))
p = p+ggtitle("Fst s1-adm en fonction de s1,0 à la génération 0")
p = p+geom_point()
p = p + xlab("s1.0") + ylab("Fst.s1.adm")
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
                                                linetype = 'solid',
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/Fst_s1_adm_gen0", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/Fst_s1_adm_gen0", ".png"), plot = p)

####################

p = ggplot(mat_cstt_multi_gen0, aes(x = s1.0, y = mean.F.adm, color = Ne))
p = p+geom_point()
p = p+ggtitle("F moyen en fonction de s1,0 à la génération 0")
p = p + xlab("s1.0") + ylab("mean.F.adm")
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
                                                linetype = 'solid',
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/F_gen0", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/F_gen0", ".png"), plot = p)
```
...
p = ggplot(mat_inc_multi_100, aes(x = s1.0, y = delta.mean.adm.props, color = U))
p = p+geom_point()
p = p+ggtitle("delta mean adm props en fonction de s1,0 à la génération 100")
p = p + xlab("s1.0") + ylab("delta mean adm props")
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_100/ne_inc_delta_s10", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_100/ne_inc_delta_s10", ".png"), plot = p)
...
p = ggplot(mat_bot_multi_100, aes(x = s1.0, y = delta.mean.adm.props, color = U))
p = p+geom_point()
p = p+ggtitle("delta mean adm props en fonction de s1,0 à la génération 100")
p = p + xlab("s1.0") + ylab("delta mean adm props")
p = p + scale_fill_OkabeIto()
...
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_100/ne_bot_delta_s10", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_100/ne_bot_delta_s10", ".png"), plot = p)
```
...
mat_cstt_ns_50 = data.frame.stat(seq_ne = c(100,1000,10000), max_gen = 101, max_simu = 1)
mat_cstt_ns_50 = delta.adm.props(mat_cstt_ns_50)

setwd("../new_methis_pop_size_diff_ns_75/")

mat_cstt_ns_75 = data.frame.stat(seq_ne = c(100,1000,10000), max_gen = 101, max_simu = 1)
mat_cstt_ns_75 = delta.adm.props(mat_cstt_ns_75)

```
```{r}
p = plot_stat_gen(mat_cstt_ns_50, mat_cstt_ns_50$Generation, 
                  mat_cstt_ns_50$delta.mean.adm.props, mat_cstt_ns_50$Ne,
                  mat_cstt_ns_50$Ne,ligne = T,
                  "Delta mean adm props en fonction des générations",
                  legd = TRUE)
p = p + guides(linetype = FALSE)
p = p + labs(color = "Ne")
...
p = plot_stat_gen(mat_cstt_ns_75, mat_cstt_ns_75$Generation, 
                  mat_cstt_ns_75$delta.mean.adm.props, mat_cstt_ns_75$Ne,
                  mat_cstt_ns_75$Ne,ligne = T,
                  "Delta mean adm props en fonction des générations",
                  legd = TRUE)
p = p + guides(linetype = FALSE)
p = p + labs(color = "Ne")
