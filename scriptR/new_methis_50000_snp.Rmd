...
write_bottle_plot_2 = function(name_stat, mat, name_file, min_y, max_y, name_x = "Generation", time_bott){
  num_col_y = which(colnames(mat) == name_stat)
  num_col_x = which(colnames(mat) == name_x)
  p = plot_stat_gen(mat, mat[,num_col_x], 
                    mat[,num_col_y], c(),
                    mat$alpha, line_t = mat$U,
                    str_c(name_stat, " en fonction des générations\n selon différents bottleneck\n (Ne0 = Nef = 1000)"),TRUE,
                    legd = TRUE)
  p = improve_plot_bottle(p =p, vec_abline = c(time_bott),
                          lab_col = "alpha",
                          lab_line = "U", vec_linetype = c("solid", "longdash", "dotted"))
  p = p+ylim(min_y, max_y)
  p = p+xlab(name_x)+ylab(name_stat)
...
write_bottle_plot_2("mean.het.adm", mini_mat_bottle_20, "moyenne_heterozygotie/moy_He_bottleneck_20",0.01,0.062, time_bott = 21)
write_bottle_plot_2("Fst.s1.adm", mini_mat_bottle_20, "Fsts1adm/fst_s1_adm_bottleneck_20", 0, 0.5, time_bott = 21)
write_bottle_plot_2("Fst.s2.adm", mini_mat_bottle_20, "Fsts2adm/fst_s2_adm_bottleneck_20", 0, 0.5, time_bott = 21)
write_bottle_plot_2("mean.F.adm", mini_mat_bottle_20, "Fadm/f_adm_bottleneck_20", -0.03, 0.03, time_bott = 21)
write_bottle_plot_2("delta.mean.adm.props", mini_mat_bottle_20, "delta_mean_adm/delta_mean_bottleneck_20", -0.25, 0.25, time_bott = 21)
write_bottle_plot_2("delta.var.adm.props", mini_mat_bottle_20, "delta_var_adm/delta_var_bottleneck_20", -0.2, 0.05, time_bott = 21)

write_bottle_plot_2("mean.het.adm", mini_mat_bottle_50, "moyenne_heterozygotie/moy_He_bottleneck_50",0.01,0.062, time_bott = 51)
write_bottle_plot_2("Fst.s1.adm", mini_mat_bottle_50, "Fsts1adm/fst_s1_adm_bottleneck_50", 0, 0.5, time_bott = 51)
write_bottle_plot_2("Fst.s2.adm", mini_mat_bottle_50, "Fsts2adm/fst_s2_adm_bottleneck_50", 0, 0.5, time_bott = 51)
write_bottle_plot_2("mean.F.adm", mini_mat_bottle_50, "Fadm/f_adm_bottleneck_50", -0.03, 0.03, time_bott = 51)
write_bottle_plot_2("delta.mean.adm.props", mini_mat_bottle_50, "delta_mean_adm/delta_mean_bottleneck_50", -0.25, 0.25, time_bott = 51)
write_bottle_plot_2("delta.var.adm.props", mini_mat_bottle_50, "delta_var_adm/delta_var_bottleneck_50", -0.2, 0.05, time_bott = 51)

write_bottle_plot_2("mean.het.adm", mini_mat_bottle_80, "moyenne_heterozygotie/moy_He_bottleneck_80",0.01,0.062, time_bott = 81)
write_bottle_plot_2("Fst.s1.adm", mini_mat_bottle_80, "Fsts1adm/fst_s1_adm_bottleneck_80", 0, 0.5, time_bott = 81)
write_bottle_plot_2("Fst.s2.adm", mini_mat_bottle_80, "Fsts2adm/fst_s2_adm_bottleneck_80", 0, 0.5, time_bott = 81)
write_bottle_plot_2("mean.F.adm", mini_mat_bottle_80, "Fadm/f_adm_bottleneck_80", -0.03, 0.03, time_bott = 81)
write_bottle_plot_2("delta.mean.adm.props", mini_mat_bottle_80, "delta_mean_adm/delta_mean_bottleneck_80", -0.25, 0.25, time_bott = 81)
write_bottle_plot_2("delta.var.adm.props", mini_mat_bottle_80, "delta_var_adm/delta_var_bottleneck_80", -0.2, 0.05, time_bott = 81)
```
...
write_one_gen = function(df, xaxis, yaxis, color_group, xlab, ylab, t_file, t_plot){
  ...
  ggsave(filename =  str_c("../../../Images/",t_file, ".eps"), plot = p)
...
p = plot_stat_gen(mat_cstt_multi_mean, mat_cstt_multi_mean$Generation, 
                  mat_cstt_multi_mean$mean.adm.props, mat_cstt_multi_mean$Ne,
...
p = p + labs(color = "Ne")
print(p)
# ggsave(filename =  str_c("../../../Images/100_simu/ne_cstt_mean", ".eps"), plot = p)
# ggsave(filename =  str_c("../../../Images/100_simu/ne_cstt_mean", ".png"), plot = p)

####################

# p = p + ylim(-0.12, 0)
p = p+geom_errorbar(aes(ymin = mean.adm.props - mat_cstt_multi_var$mean.adm.props,
                        ymax = mean.adm.props + mat_cstt_multi_var$mean.adm.props),
                    width=0.6)
print(p)
# ggsave(filename =  str_c("../../../Images/100_simu/ne_cstt_mean_IC95", ".eps"),plot = p)
# ggsave(filename =  str_c("../../../Images/100_simu/ne_cstt_mean_IC95", ".png"),plot = p)
...
```{r}
####################
write_one_gen(mat_cstt_multi_100, mat_cstt_multi_100$s1.0,
...
p = ggplot(mat_cstt_multi_gen0, aes(x = s1.0, y = mean.het.adm, color = Ne))
p = p+ggtitle("Hétérozygotie moyenne en fonction de s1,0 à la génération 0")
p = p+geom_point()
p = p+geom_hline(yintercept = 0.062, linetype = "dashed", color = "#DB0073")
p = p+geom_hline(yintercept = 0.049, linetype = "dashed", color = "#6E0B14")
p = p+annotate(geom="text", x=0, y=0.0625, label="s1", color="#DB0073")
p = p+annotate(geom="text", x=0, y=0.0485, label="s2", color="#6E0B14")
p = p + xlab("s1.0") + ylab("mean.het.adm")
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
                                                linetype = 'solid',
              ...
              panel.grid.minor.y = element_line(size = 0.25,
                                                ...
                                                colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/He_gen0", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu_gen_0/He_gen0", ".png"), plot = p)
...
p = p + labs(color = "U", linetype = "Ne0-Nef")
p = p + ylim(-0.1, 0)
print(p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_inc_mean", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_inc_mean", ".png"), plot = p)
...
p = p+geom_errorbar(aes(ymin = delta.mean.adm.props - mat_inc_multi_var$delta.mean.adm.props,
                    ...
                    width=0.6)
print(p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_inc_mean_IC95", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_inc_mean_IC95", ".png"), plot = p)

####################

write_one_gen(mat_inc_multi_100, mat_inc_multi_100$s1.0,
...
p = plot_stat_gen(df = mat_bot_multi_mean, gen = mat_bot_multi_mean$Generation, 
                  ...
                  titre = "Delta mean adm props en fonction des générations",
                  legd = TRUE)
p = p + labs(color = "U", linetype = "alpha")
p = p + ylim(-0.1, 0)
print(p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_bott_mean", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_bott_mean", ".png"), plot = p)
...
p = p+geom_errorbar(aes(ymin = delta.mean.adm.props - mat_bot_multi_var$delta.mean.adm.props,
                    ...
                    width=0.6)
print(p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_bott_mean_IC95", ".eps"), plot = p)
ggsave(filename =  str_c("../../../Images/100_simu/ne_bott_mean_IC95", ".png"), plot = p)

####################

write_one_gen(mat_bot_multi_100, mat_bot_multi_100$s1.0,
...
```{r}
p = ggplot(mat_64_100_16384, aes(x = Generation, y = Ne, group = Ne, color = Ne))
p = p + geom_line()
p = p + scale_fill_OkabeIto()
p = p + theme_classic()
p = p + theme(panel.grid.major.y = element_line(size = 0.5,
                ...
                panel.grid.minor.y = element_line(size = 0.25,
                                                  ...
                                                  colour = "#CECECE"))
print(p)
ggsave(filename =  str_c("../../../Images/ne_vite.png"), plot = p)
```
