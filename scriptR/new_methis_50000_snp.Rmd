...
```{r}
write_increase_plot("mean.het.adm", mat_pop_nu3, "moyenne_heterozygotie/moy_He_pop_inc_nu_var",0.01,0.062)
...
data.frame.bottleneck = function(lst_ne0, lst_nef, lst_alpha, lst_nu, lst_bottle){
  ...
  if(!is.null(mat_bot)){
    ...
    mat_bot$cpt = as.factor(mat_bot$cpt)
...
```{r}
boucle_plot_bottle(mat_bottle_10.000, mat_bottle_10.000$mean.het.adm, "Heterozygotie", c(20,50,80))
...
```{r}
boucle_plot_bottle(mat_bottle_100.000, mat_bottle_100.000$mean.het.adm, "Heterozygotie", c(20,50,80))
