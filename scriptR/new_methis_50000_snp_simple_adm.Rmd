...
knitr::opts_knit$set(root.dir = "~/Documents/git_repository/Stage/Simulations/SNP_AFR_EUR")
...
```{r}
setwd("new_methis_pop_size_diff_50000_snp")
...
δ
```{r}
write_cstt_plot("mean.het.adm", mat_64_100_16384, "moyenne_heterozygotie/moy_He_ne_cst", 0.01, 0.064,ylab = "mean He")
...
write_cstt_plot("var.adm.props", mat_64_100_16384, "var_adm/var_adm_ne_cst", 0, 0.2,
                ylab = "Variance du taux d'admixture")
write_cstt_plot("delta.mean.adm.props", mat_64_100_16384, "delta_mean_adm/delta_mean_ne_cstt",
                -0.25, 0.25,
...
write_cstt_plot("f3", mat_64_100_16384, "f3/f3_ne_cstt", -0.3, 2,ylab = "f3")
write_cstt_plot("delta.adm.gen.0", mat_64_100_16384, "delta_adm_gen0/delta_gen0_ne_cstt",
                -0.2, 0.17,
...
```{r}
write_increase_plot("mean.het.adm", mat_pop_nu_reduce_3, "moyenne_heterozygotie/moy_He_pop_inc_nu_var",0.01,0.064,ylab = "mean He")
write_increase_plot("mean.het.adm", mat_pop_nu_reduce_3, "presentation/moy_He_pop_inc_nu_var",0.017,0.064,ylab = "mean He")
write_increase_plot("Fst.s1.adm", mat_pop_nu_reduce_3, "Fsts1adm/fst_s1_adm_pop_inc_nu_var", 0, 0.5,ylab = expression(paste(F[ST], " s1-adm", sep = "")))
write_increase_plot("Fst.s2.adm", mat_pop_nu_reduce_3, "Fsts2adm/fst_s2_adm_pop_inc_nu_var", 0, 0.5,ylab = expression(paste(F[ST], " s2-adm", sep = "")))
write_increase_plot("mean.F.adm", mat_pop_nu_reduce_3, "Fadm/f_adm_pop_inc_nu_var", -0.03, 0.03,ylab="F")
write_increase_plot("mean.adm.props", mat_pop_nu_reduce_3, "adm.props/adm_props_ne_inc", -0.032, 1, ylab = "Average admixture rate")
write_increase_plot("var.adm.props", mat_pop_nu_reduce_3, "var_adm/var_adm_ne_inc", -0.032, 1, ylab = "Variance du taux d'admixture")
write_increase_plot("delta.mean.adm.props", mat_pop_nu_reduce_3,
                    "delta_mean_adm/delta_mean_pop_inc_nu_va", -0.25, 0.25,
                    ylab = expression(paste(δ[µ["observée"]-µ["théorique"]], sep = "")))
write_increase_plot("delta.var.adm.props", mat_pop_nu_reduce_3,
                    "delta_var_adm/delta_var_pop_inc_nu_va", -0.2, 0.05,
                    ylab = expression(paste(δ[σ2["observée"] - σ2["théorique"]], sep = "")))
write_increase_plot("ne_gen", mat_pop_nu_reduce_3, "Ne/Ne_inc_all", 99, 10000,ylab="Ne")
write_increase_plot("f3", mat_pop_nu_reduce_3, "f3/f3_ne_inc", -0.3, 2,ylab="f3")
write_increase_plot("delta.adm.gen.0", mat_pop_nu_reduce_3,
                    "delta_adm_gen0/delta_gen0_ne_inc", -0.2, 0.15,
                    ylab = expression(paste(δ[µ["g"]-µ[0]], sep = "")))
```
...
write_bottle_plot("mean.F.adm", mini_mat_bottle, "Fadm/f_adm_bottleneck", -0.03, 0.03,
                  ylab="F")
write_bottle_plot("mean.adm.props", mini_mat_bottle, "adm.props/adm_props_ne_bot", -0.02, 1,
                  ylab = "Average admixture rate")
...
write_bottle_plot("delta.mean.adm.props", mini_mat_bottle,
                  "delta_mean_adm/delta_mean_bottleneck", -0.25, 0.25,
                  ylab = expression(paste(δ[µ["observée"]-µ["théorique"]], sep = "")))
...
write_bottle_plot("log.delta.var", mini_mat_bottle,
                  "delta_var_adm/log_delta_var_bottleneck", -15, 0,ylab = "log.delta.var")
write_bottle_plot("ne_gen", mini_mat_bottle, "Ne/Ne_bot_all", 100, 1000,ylab="Ne")
write_bottle_plot("f3", mini_mat_bottle, "f3/f3_ne_bot", -0.3, 2,ylab = "Ne")
write_bottle_plot("delta.adm.gen.0", mini_mat_bottle, "delta_adm_gen0/delta_gen0_ne_bott", -0.2, 0.15,ylab = expression(paste(δ[µ["g"]-µ[0]], sep = "")))
```
...
for (i in c(1:3)) {
  write_bottle_plot(name_stat = "mean.het.adm", mat = lst_bot[[i]],
                    name_file = str_c("moyenne_heterozygotie/moy_He_bottleneck_",vec_bot[i]), 
