...
δ
```{r}
write_cstt_plot("mean.het.adm", mat_64_100_16384, "moyenne_heterozygotie/moy_He_ne_cst", 0.01, 0.064,ylab = "He moyenne")
...
write_cstt_plot("mean.adm.props", mat_64_100_16384, "adm.props/adm_props_ne_cst", 0, 1,
                ylab = "Moyenne du taux d'admixture")
...
```{r}
write_increase_plot("mean.het.adm", mat_pop_nu_reduce_3, "moyenne_heterozygotie/moy_He_pop_inc_nu_var",0.01,0.064,ylab = "He moyenne")
...
write_increase_plot("mean.adm.props", mat_pop_nu_reduce_3, "adm.props/adm_props_ne_inc", -0.032, 1, ylab = "Moyenne du taux d'admixture")
...
write_bottle_plot("mean.het.adm", mini_mat_bottle,
                  ...
                  vec_abtype = c("solid", "dashed", "dotted"),ylab="He moyenne")
