...
def parse_args() :
    ...
    return values.nb_simulation, values.nb_generation, values.prefix, values.Ne, values.contrib_s1, values.contrib_s2, values.nu_value, values.alpha, values.tb, values.force_rewrite
...
def generate_contribution(pattern, nb_generation, nu_val) :
    c0 = pattern[0]
    scheme = pattern[1]
...
def main() :
    ...
    nb_simulation, nb_generation, prefix, Ne_str, contrib_s1_str, contrib_s2_str, nu, alpha, tb, force_rewrite = parse_args()
