...
def parse_args() :
    ...
    return values.nb_simulation, values.nb_generation, values.prefix, values.Ne, values.contrib_s1, values.contrib_s2, values.nu_value, values.force_rewrite
...
def generate_Nes(pattern, nb_generation, nu_val) :
    Ne0 = pattern[0]
    scheme = pattern[1]
...
def main() :
    ...
    nb_simulation, nb_generation, prefix, Ne_str, contrib_s1_str, contrib_s2_str, nu, force_rewrite = parse_args()
    ...
    for i in xrange(1, nb_simulation+1) :
        uNe, new_Nes = generate_Nes(Ne_pattern, nb_generation, nu)
        uNe = nu
