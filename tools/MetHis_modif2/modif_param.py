...
def parse_args():
    ...
    return values.alpha, values.nu, values.ne0, values.nef, values.bottle, values.gen
...
#main function
def main():
    alpha, nu, ne0, nef, bottle, gen = parse_args()
    path = "alpha"+alpha+"/Nu"+nu+"/bottle"+bottle+"/Ne"+ne0+"-XXX/Ne"+ne0+"-"+nef+"/simu_1/simu_1.par"
