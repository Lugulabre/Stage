...
for s1 in 5; do
    ...
    for ne in 100 1000 10000; do
        ...
        ../../../../tools/MetHis_modif/generate_params.py -S 50 -N 100 -P "s1.0_0.$s1/Ne$size_ne/" --Ne "$size_ne/Con/$size_ne-$size_ne" --contrib_s1 0.$s1/Dec/0.4-0.4/0.01-0.01 --contrib_s2 0.$s2/Dec/0.4-0.4/0.01-0.01 --force-rewrite
