...
for (( pow = 10; pow < 15; pow++ )); do
    ...
    ../../../tools/MetHis_modif/generate_params.py -S 10 -N 100 -P "Ne$size_ne/" --Ne "$size_ne/Con/$size_ne-$size_ne" --contrib_s1 default/Pulse/0 --contrib_s2 default/Pulse/0 --force-rewrite

    ../../../tools/MetHis_modif/MetHis --sampling 25/25/25 --nb-snp 50000 --max-Ne $size_max_ne --prefix "Ne$size_ne" --nb-simul 10 --nb-thread 30 --input-path ../../../tools/MetHis_modif/example_dataset/data_50k.arp
