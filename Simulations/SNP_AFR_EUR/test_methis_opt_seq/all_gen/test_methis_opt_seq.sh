...
for size_ne in 100 1000 10000; do
    #echo $pow
    ((size_max_ne = $size_ne*2))
    rm -r "Ne$size_ne"
    mkdir "Ne$size_ne"

    ../../../../tools/MetHis_save/generate_params.py -S 1 -N 100 -P "Ne$size_ne/" --Ne "$size_ne/Con/$size_ne-$size_ne" --contrib_s1 default/Pulse/0 --contrib_s2 default/Pulse/0 --force-rewrite

    ../../../../tools/MetHis_save/MetHis --sampling 25/25/25 --nb-snp 50000 --max-Ne $size_max_ne --prefix "Ne$size_ne" --nb-simul 1 --nb-thread 20 --input-path ../../../../tools/MetHis_modif/example_dataset/data_50k.arp --save-all-gen True
