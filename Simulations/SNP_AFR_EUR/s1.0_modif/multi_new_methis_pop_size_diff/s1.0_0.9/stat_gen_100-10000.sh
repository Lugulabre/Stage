...
for pow in 10000; do
    ...
    ../../../../../tools/MetHis_modif/generate_params.py -S 100 -N 100 -P "Ne$size_ne/" --Ne "$size_ne/Con/$size_ne-$size_ne" --contrib_s1 0.9/Pulse/0 --contrib_s2 0.1/Pulse/0 --force-rewrite

    ../../../../../tools/MetHis_modif/MetHis --sampling 25/25/25 --nb-snp 50000 --max-Ne $size_max_ne --prefix "Ne$size_ne" --nb-simul 100 --nb-thread 10 --input-path ../../../../../tools/MetHis_modif/example_dataset/data_50k.arp
