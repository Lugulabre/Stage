...
for nu in 0.01 0.25 0.49; do
    ...
    for (( ne0 = 100; ne0 < 101; ne0=ne0+10 )); do
        ...
        for nen in 200 400 1000 10000; do
            #echo $nen
            #((nen=$ne0*$pre_nen))
            #comp=$nen-$ne0
            #if [[ $comp -gt 0 ]]; then
            ...
            ../../../tools/MetHis_modif/generate_params_nu.py -S 100 -N 100 -P "Nu$nu/Ne$ne0-XXX/Ne$ne0-$nen/" --Ne "$ne0/Inc/$nen-$nen" --contrib_s1 default/Pulse/0 --contrib_s2 default/Pulse/0 --Nu $nu --force-rewrite
