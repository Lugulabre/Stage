        ...
        for tps_gen in 20 50; do
            ...
            for (( ne0 = 1000; ne0 < 1001; ne0=ne0+1000 )); do
                ...
                for (( nen = 1000; nen < 1001; nen=nen+1000 )); do
                    ...
                    ../../../tools/MetHis_modif/generate_params_nu.py -S 100 -N $tps_gen -P "alpha$alpha/Nu$nu/bottle$tps_gen/Ne$ne0-XXX/Ne$ne0-$nen" --Ne "$ne0red/Inc/$nen-$nen" --contrib_s1 default/Pulse/0 --contrib_s2 default/Pulse/0 --Nu $nu --force-rewrite

                    ../../../tools/MetHis_modif/bottleneck_param.py -A $alpha -U $nu -ne0 $ne0 -nef $nen -B $tps_gen -G 100 -S 100

                    ../../../tools/MetHis_modif/MetHis --sampling 25/25/25 --nb-snp 50000 --max-Ne $size_max_ne --prefix "alpha$alpha/Nu$nu/bottle$tps_gen/Ne$ne0-XXX/Ne$ne0-$nen/" --nb-simul 100 --nb-thread 25 --input-path ../../../tools/MetHis_modif/example_dataset/data_50k.arp
