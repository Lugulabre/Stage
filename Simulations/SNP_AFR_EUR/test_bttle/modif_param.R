...
setwd("~/Documents/git_repository/Stage/Simulations/SNP_AFR_EUR/test_bttle/")
...
path_tot = str_c("alpha",alpha,"/Nu0.",nu,"/Ne",ne0,"-XXX/Ne",
                 ne0,"-",nen,"/bottle",bottle,"/simu_1/simu_1.par")
