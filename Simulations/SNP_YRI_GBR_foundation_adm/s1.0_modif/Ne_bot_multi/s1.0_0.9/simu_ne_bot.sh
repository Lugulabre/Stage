        ...
        for tps_gen in 80; do
            ...
            for (( ne0 = 1000; ne0 < 1001; ne0=ne0+1000 )); do
                ...
                for (( nen = 1000; nen < 1001; nen=nen+1000 )); do
                    ...
                    ../../../../../tools/MetHis_modif/generate_params_nu.py -S 100 -N $tps_gen -P "alpha$alpha/Nu$nu/bottle$tps_gen/Ne$ne0-XXX/Ne$ne0-$nen" --Ne "$ne0red/Inc/$nen-$nen" --contrib_s1 0.9/Pulse/0 --contrib_s2 0.1/Pulse/0 --Nu $nu --force-rewrite
