...
for pow in 10000; do
    ...
    ../../../../../tools/MetHis_modif/generate_params.py -S 100 -N 100 -P "Ne$size_ne/" --Ne "$size_ne/Con/$size_ne-$size_ne" --contrib_s1 0.5/Pulse/0 --contrib_s2 0.5/Pulse/0 --force-rewrite
