...
for nu in 0.01 0.25 0.49; do
    ...
    for (( ne0 = 50; ne0 < 101; ne0=ne0+10 )); do
        ...
        for nen in 200 400 500 1000 5000 10000; do
            ...
            ../../../tools/MetHis_modif/generate_params_nu.py -S 1 -N 100 -P "Nu$nu/Ne$ne0-XXX/Ne$ne0-$nen/" --Ne "$ne0/Inc/$nen-$nen" --contrib_s1 default/Pulse/0 --contrib_s2 default/Pulse/0 --Nu $nu --force-rewrite

            ../../../tools/MetHis_modif/MetHis --sampling 25/25/25 --nb-snp 50000 --max-Ne $size_max_ne --prefix "Nu$nu/Ne$ne0-XXX/Ne$ne0-$nen/" --nb-simul 1 --nb-thread 30 --input-path ../../../tools/MetHis_modif/example_dataset/data_50k.arp
            #else
            #    rm -r "Nu$nu/Ne$ne0-XXX/Ne$ne0-$nen"
            #fi
        done
