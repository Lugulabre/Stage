...
for pow in 100 1000 10000; do
    ...
    ../../../../tools/MetHis_modif/MetHis --sampling 50/50/50 --nb-snp 50000 --max-Ne $size_max_ne --prefix "Ne$size_ne" --nb-simul 100 --nb-thread 20 --input-path ../../../../tools/MetHis_modif/example_dataset/data_50k.arp
