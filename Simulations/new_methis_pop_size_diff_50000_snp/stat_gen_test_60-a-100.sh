...
for (( pow = 50; pow < 1000; pow++ )); do
    ...
    ../../tools/MetHis_modif/MetHis --sampling 25/25/25 --nb-snp 50000 --max-Ne $size_max_ne --prefix "Ne$size_ne" --nb-simul 1 --nb-thread 10 --input-path ../../tools/MetHis_modif/example_dataset/data_50k.arp
